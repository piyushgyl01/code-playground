...
let totalCost = notebookCost + pencilCost + penCost
...
let meetsCriteria = tvScreenSize >= 50 && (tvBrand === "Sony" || "Samsung") && tvPrice <= 60000
...
let isDiscountApplicable = watchReleaseYear === currentYear - 1 && (watchBrand === "Apple" || "Samsung") && (watchSize === "M" || "L")
