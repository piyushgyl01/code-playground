...
console.log("Is student eligible for scholarship? ", isEligibleForScholarship)
...
console.log("Does the user qualify for the free shipping? " + qualifiesForFreeShipping)
...
let isAffordable = totalCost <= hdfcBalance || totalCost <= sbiBalance
...
console.log("Does the shirt matches the filters? ", matchesFilters)
